...
{
    public class ProgramOneTphToOneTphDifferentDiscriminatorTypesAndNames
    {
        ...
        [Fact]
        public static void One_TablePerHierarchy_To_One_TablePerHierarchy_Different_Discriminator_Types_And_Names()
        {
            var options = new DbContextOptionsBuilder()
                .UseSqlServer($"Data Source=(local);Initial Catalog=Test_{nameof(ProgramOneTphToOneTphDifferentDiscriminatorTypesAndNames)};Integrated Security=SSPI;").Options;
